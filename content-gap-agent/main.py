...
def main() -> int:
    ...
    try:
        # Use the lean public API (title-based, Semrush-scored)
        ...
        # Shape to match the format expected by reporter + script_writer
        gap_analysis = {
            ...
            "top_gaps": [
                {
                    ...
                    "topic": g["topic"],
                    "gap_description": (
                        f"Competitor covers this; similarity score "
    ...
    scripts: list[dict] = []
    try:
        # Generate the #1 gap script using the public API
        if top3:
        ...
        # Generate batch scripts for gaps 2 and 3 via run_script_writer
